...
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders when other list items change state
...
export default function App() {
  ...
  // ⚡ Bolt: Wrapped in useCallback to preserve function reference and enable child memoization
  ...
  }, []); // Functional state update means no dependencies needed
