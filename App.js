...
// ⚡ Bolt: Wrapped with React.memo to prevent unnecessary re-renders when other items change
...
export default function App() {
  ...
  // ⚡ Bolt: Memoized callback to maintain reference equality for React.memo
