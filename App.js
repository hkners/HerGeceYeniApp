...
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders of list items when other items change.
...
export default function App() {
  ...
  // ⚡ Bolt: Memoized toggle callback to ensure it maintains the same reference across renders,
  // preventing memoized children from re-rendering unnecessarily.
