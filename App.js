...
// ⚡ Bolt: Memoized BreathingContainer to prevent unnecessary re-renders of all list items
...
export default function App() {
  ...
  // ⚡ Bolt: Wrapped in useCallback to maintain reference equality and prevent child re-renders
