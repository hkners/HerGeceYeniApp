...
// ⚡ Bolt Optimization: Memoize the container to prevent re-rendering unchanged items
...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Memoize the toggle handler to maintain a stable reference
  // since it uses functional state updates, the dependency array is empty.
