...
// Bolt: Prevents unnecessary re-renders of the entire list when a single item is toggled
...
export default function App() {
  ...
  // Bolt: Memoized the toggle handler to maintain referential equality across renders
