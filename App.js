...
// ⚡ Bolt: Memoize component to prevent unnecessary re-renders when other list items change
...
export default function App() {
  ...
  // ⚡ Bolt: Memoize callback to prevent breaking React.memo on list items
