...
// ⚡ Bolt: Memoized component to prevent unnecessary re-renders when other items toggle
...
export default function App() {
  ...
  // ⚡ Bolt: Memoized handler with empty deps since it uses functional state update
