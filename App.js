...
// Optimization: Prevent unnecessary re-renders of list items when other items are toggled
...
export default function App() {
  ...
  // Optimization: Memoize the toggle function to maintain reference equality for memoized children
