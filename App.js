...
// ⚡ Bolt: Memoize the component to prevent re-rendering when other list items change
...
export default function App() {
  ...
  // ⚡ Bolt: Memoize the toggle handler to prevent unnecessary re-renders of the list items
