...
// ⚡ Bolt: Memoize the component to prevent unnecessary re-renders of untoggled items
...
export default function App() {
  ...
  // ⚡ Bolt: Memoize callback to prevent breaking React.memo on child components
