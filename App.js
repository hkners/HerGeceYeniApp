...
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders of all items when only one is toggled.
...
export default function App() {
  ...
  // ⚡ Bolt: Memoized callback to maintain stable reference across renders, working in tandem with React.memo
