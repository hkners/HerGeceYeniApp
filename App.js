...
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders of unmodified list items
...
export default function App() {
  ...
  // ⚡ Bolt: Wrapped in useCallback to preserve function reference across renders
