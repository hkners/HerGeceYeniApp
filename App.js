...
const BreathingContainer = React.memo(({ intention, onToggle }) => {
  ...
  useEffect(() => {
    // ⚡ Bolt: Capture loop animation to stop it on cleanup and prevent native thread memory leaks
    let animation;
    ...
    // ⚡ Bolt: Clean up animation on unmount or dependency change
    return () => {
...
export default function App() {
  ...
  // ⚡ Bolt: Memoize callback to prevent unnecessary re-renders of child components
