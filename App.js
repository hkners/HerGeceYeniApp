...
// ⚡ Bolt: Memoize list item to prevent re-renders of the entire list when a single item changes
const BreathingContainer = memo(({ intention, onToggle }) => {
  ...
  useEffect(() => {
    ...
    // ⚡ Bolt: Cleanup animation reference to prevent orphaned animations on the native thread
    return () => {
...
export default function App() {
  ...
  // ⚡ Bolt: Memoize callback to preserve referential equality for child components
