...
// ⚡ Bolt Optimization: Memoize the container to prevent O(N) re-renders when a single intention is toggled
...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Use useCallback to maintain reference equality and allow child memoization to work
