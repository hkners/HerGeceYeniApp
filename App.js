...
// ⚡ Bolt: Wrapped list item in React.memo to prevent unnecessary re-renders
// Impact: Reduces rendering time when toggling an item from O(N) to O(1)
...
export default function App() {
  ...
  // ⚡ Bolt: Memoized interaction handler using React.useCallback
  // Impact: Maintains stable reference across renders, enabling child component memoization
