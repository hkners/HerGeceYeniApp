...
// ⚡ Bolt: Memoized component to prevent unnecessary re-renders of list items when one changes
...
export default function App() {
  ...
  // ⚡ Bolt: Memoized callback to maintain stable reference across App re-renders
