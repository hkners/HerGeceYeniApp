...
// ⚡ Bolt: Memoize component to prevent O(n) re-renders when a single list item is toggled
...
export default function App() {
  ...
  // ⚡ Bolt: Stable function reference so BreathingContainer's React.memo can skip re-renders
